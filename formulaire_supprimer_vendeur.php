	...
	<body>
			...
			<form action="supprimer_vendeur.php" method="post">
					<table>
							...
							<tr>
								<td>
 								<input type="submit" name="button2" value="Supprimer" style="width:100px;padding:7px;height:30px;background-color: AliceBlue;border-radius:20px"></td>
