...
<div class="confirm rounded border border-dark">
<br>
 Un email de confirmation a été envoyé a <?php echo $_SESSION["newsession"] ?> <br><br> Merci pour votre confiance et a bientot !"
 <br><br>
